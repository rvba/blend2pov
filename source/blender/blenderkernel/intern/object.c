 ...
 *
 * 
 * $Id: object.c 14306 2008-04-01 11:14:34Z campbellbarton $
 *
...
void *add_lamp(char *name)
{
	...
	la->pov_light_power_fading=0;

	la->povsun_size=1;
	la->povsun_turbidity=2;
	la->povsun_max=5000;
	la->povsun_min=72;
	la->povsun_hor=1;
	la->povsun_corr=1;
	la->povsun_sun_weight=2;
	la->povsun_horizon_weight=1;
	la->povsun_zenith_weight=1;
	la->povsun_tesselation=0.95;
	la->povsun_mult=.75;
	la->povsun_sun_weight=2;
	la->povsun_horizon_weight=1;
	la->povsun_zenith_weight=1;
