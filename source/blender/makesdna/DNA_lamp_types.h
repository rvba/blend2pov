 ...
 *
 * $Id: DNA_lamp_types.h 13585 2008-02-05 21:09:38Z aligorith $ 
 *
...
typedef struct Lamp {
	...
	int pov_light_power_fading;
	int povsun;
	int povsun_size,povsun_turbidity,povsun_max,povsun_min,povsun_corr;
	float povsun_tesselation,povsun_mult,povsun_hor;

	int povsun_sun_weight,povsun_horizon_weight,povsun_zenith_weight; 
	/*char pov_light_projected[32];*/
	ID pov;
	int pov_light_projected_toggle; 
