 ...
 *
 * $Id: DNA_material_types.h 14063 2008-03-12 09:04:07Z campbellbarton $ 
 *
...
typedef struct Material {
	...
	/*milo*/
	int povmat_image_pattern[10];
	/* blur */
	float pov_mat_blur_amount;
	int pov_mat_blur_samples;
	int pov_mat_blur_toggle;
	int pov_mat_pad;
