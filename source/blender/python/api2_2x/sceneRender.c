/* 
 * $Id: sceneRender.c 14280 2008-03-29 15:20:41Z campbellbarton $
 *
...
static PyObject *RenderData_SetBorder( BPy_RenderData * self,
		PyObject * args );
/*milo*/
static PyObject *RenderData_POVSetBorder( BPy_RenderData * self,
		PyObject * args );
...
static int RenderData_POVsetBorder( BPy_RenderData * self, PyObject * args )
{
	float xmin, ymin, xmax, ymax;
	...
	self->renderContext->povborder.xmin = EXPP_ClampFloat( xmin, 0.0, 1.0 );
	self->renderContext->povborder.xmax = EXPP_ClampFloat( xmax, 0.0, 1.0 );
	self->renderContext->povborder.ymin = EXPP_ClampFloat( ymin, 0.0, 1.0 );
	self->renderContext->povborder.ymax = EXPP_ClampFloat( ymax, 0.0, 1.0 );
...
static PyObject *RenderData_POVgetBorder( BPy_RenderData * self )
{
	return Py_BuildValue( "[ffff]", 
			self->renderContext->povborder.xmin,
			self->renderContext->povborder.ymin,
			self->renderContext->povborder.xmax,
			self->renderContext->povborder.ymax );
}
...
/* R_BG_RENDER unused */
	...
	/*milo*/
	{"POVborder",
	 (getter)RenderData_POVgetBorder, (setter)RenderData_POVsetBorder,
	 "The border for border rendering",
	 NULL},
	{"timeCode",
...
static PyMethodDef BPy_RenderData_methods[] = {
	...
	/*milo*/
	{"POVsetBorder", ( PyCFunction ) RenderData_POVSetBorder, METH_VARARGS,
	 "(f,f,f,f) - set the border for border rendering"},
...
{
	return EXPP_setterWrapperTuple( (void *)self, args,
			(setter)RenderData_POVsetBorder );
}
