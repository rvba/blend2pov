/**
 * $Id: convertblender.c 14261 2008-03-27 11:44:36Z blendix $
 *
...
static GroupObject *add_render_lamp(Render *re, Object *ob)
{
	...
	/*render_types.h*/
	/*light*/
	lar->pov_light_power_fading = la->pov_light_power_fading;
	lar->pov_light_projected_toggle = (la->pov_light_projected_toggle);
	/*lar->pov.name = la->pov.name;*/
/*	lar->pov_light_projected[32] = la->pov_light_projected[32];*/
	/*sun*/
	/*projected_through*/
	/*lar->pov_light_name=(char)(la->pov.name);*/
	lar->povsun = la->povsun;
	lar->povsun_size=la->povsun_size;
	lar->povsun_turbidity=la->povsun_turbidity;
	lar->povsun_mult=la->povsun_tesselation;
	lar->povsun_max=la->povsun_max;
	lar->povsun_min=la->povsun_min;
	lar->povsun_hor=la->povsun_hor;
	lar->povsun_sun_weight=la->povsun_sun_weight;
	lar->povsun_horizon_weight=la->povsun_horizon_weight;
	lar->povsun_zenith_weight=lar->povsun_zenith_weight;
