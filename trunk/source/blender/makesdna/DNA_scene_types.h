/**
 * $Id: DNA_scene_types.h 14243 2008-03-26 14:50:29Z campbellbarton $ 
 *
...
typedef struct RenderData {
	...
	int PovSalva,PovCarga,PovRadio,PovPhot,PovJitter,PovEjecuta;
	float PovDefaultAmbient;

	int povmode,povRadio;
	char povAislatedObject[24];

	/*milo*/

	int povshift,povbeta,povINI;
	rctf povborder;
...
/* PovRay mode */
/*milo*/
#define R_POV_SAVE_RAD_PH   1
#define R_POV_LOAD_RAD_PH	2
#define R_POV_PHOTONS		4
#define R_POV_JITTER	    8
#define R_POV_EXECUTE       16
#define R_POV_NOT_SEND_MESH 32

#define R_POV_SHIFT			1
#define R_POV_BETA			1
